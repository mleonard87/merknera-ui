  ...
  render () {
    ...
    return (
      <div>
        ...
        <p className={styles.accountText}>
          Account information is managed via your Google account. Youe email address is not shared with anyone else.
        </p>
        ...
        <h2 className={styles.tokenHeading}>API Tokens</h2>
        {apiTokens}
      </div>
    );
  }
...
export default connect(mapStateToProps, mapDisptachToProps)(AccountView);
